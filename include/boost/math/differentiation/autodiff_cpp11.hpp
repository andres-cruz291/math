...
BOOST_MATH_CUDA_ENABLED auto make_fvar_for_tuple(mp::index_sequence<Is...>, RealType const& ca)
...
BOOST_MATH_CUDA_ENABLED auto make_ftuple_impl(mp::index_sequence<Is...>, RealTypes const&... ca)
