...
BOOST_MATH_CUDA_ENABLED void fvar<RealType, Order>::fvar_cpp11(std::true_type, RootType const& ca, bool const is_variable) {
...
template <typename RealType, size_t Order>
template <typename RootType>
BOOST_MATH_CUDA_ENABLED void fvar<RealType, Order>::fvar_cpp11(std::false_type, RootType const& ca, bool const is_variable) {
  v.front() = ca;
  if (0 < Order) {
...
BOOST_MATH_CUDA_ENABLED get_type_at<RealType, sizeof...(Orders)> fvar<RealType, Order>::at_cpp11(std::true_type,
                                                                         size_t order,
                                                                         Orders...) const {
  return v.at(order);
}
...
template <typename RealType, size_t Order>
template <typename... Orders>
BOOST_MATH_CUDA_ENABLED get_type_at<RealType, sizeof...(Orders)> fvar<RealType, Order>::at_cpp11(std::false_type,
                                                                         size_t order,
                                                                         Orders... orders) const {
...
BOOST_MATH_CUDA_ENABLED constexpr T product(Ts...) {
  return static_cast<T>(1);
}

template <typename T, typename... Ts>
BOOST_MATH_CUDA_ENABLED constexpr T product(T factor, Ts... factors) {
...
class Curry {
 ...
 public:
  ...
  BOOST_MATH_CUDA_ENABLED RootType operator()(Indices... indices) const {
...
BOOST_MATH_CUDA_ENABLED fvar<RealType, Order> fvar<RealType, Order>::epsilon_multiply_cpp11(std::true_type,
                                                                    SizeType z0,
                                                                    size_t isum0,
...
template <typename RealType, size_t Order>
template <typename SizeType>
BOOST_MATH_CUDA_ENABLED fvar<RealType, Order> fvar<RealType, Order>::epsilon_multiply_cpp11(std::false_type,
                                                                    SizeType z0,
                                                                    size_t isum0,
                                                                    fvar<RealType, Order> const& cr,
                                                                    size_t z1,
...
template <typename RealType, size_t Order>
template <typename RootType>
BOOST_MATH_CUDA_ENABLED fvar<RealType, Order>& fvar<RealType, Order>::multiply_assign_by_root_type_cpp11(std::true_type,
                                                                                 bool is_root,
                                                                                 RootType const& ca) {
  auto itr = v.begin();
...
template <typename RealType, size_t Order>
template <typename RootType>
BOOST_MATH_CUDA_ENABLED fvar<RealType, Order>& fvar<RealType, Order>::multiply_assign_by_root_type_cpp11(std::false_type,
                                                                                 bool is_root,
                                                                                 RootType const& ca) {
  auto itr = v.begin();
  if (is_root || *itr != 0)
...
template <typename RealType, size_t Order>
template <typename RootType>
BOOST_MATH_CUDA_ENABLED fvar<RealType, Order>& fvar<RealType, Order>::negate_cpp11(std::true_type, RootType const&) {
...
template <typename RealType, size_t Order>
template <typename RootType>
BOOST_MATH_CUDA_ENABLED fvar<RealType, Order>& fvar<RealType, Order>::negate_cpp11(std::false_type, RootType const&) {
...
template <typename RealType, size_t Order>
template <typename RootType>
BOOST_MATH_CUDA_ENABLED fvar<RealType, Order>& fvar<RealType, Order>::set_root_cpp11(std::true_type, RootType const& root) {
...
template <typename RealType, size_t Order>
template <typename RootType>
BOOST_MATH_CUDA_ENABLED fvar<RealType, Order>& fvar<RealType, Order>::set_root_cpp11(std::false_type, RootType const& root) {
  v.front() = root;
  return *this;
}
...
BOOST_MATH_CUDA_ENABLED auto make_fvar_for_tuple(mp11::index_sequence<Is...>, RealType const& ca)
...
BOOST_MATH_CUDA_ENABLED auto make_ftuple_impl(mp11::index_sequence<Is...>, RealTypes const&... ca)
